...
import com.bank.msbootcoincustomerbackend.mocks.CustomerMock;
...
public class CustomerRestControllerTest {
    ...
    void findByIdTest() {
        ...
        webClient.get().uri("/api/bootcoin/customer/{id}", "62edbc767ba3a05551fb10d6")
                .exchange()
                .expectStatus().isOk()
                .expectBody(ResponseHandler.class);
    ...
    void updateTest() {
        ...
        webClient
                .put()
                .uri("/api/bootcoin/customer/{id}", "62edbc767ba3a05551fb10d6")
                .contentType(MediaType.APPLICATION_JSON)
                .body(BodyInserters.fromObject(customer))
                .exchange()
                .expectStatus().isOk();
    ...
    void deleteTest() {
        ...
        webClient.delete().uri("/api/bootcoin/customer/{id}", "62edbc767ba3a05551fb10d6")
                .exchange()
                .expectStatus().isOk();
    }
}
